...
public class AepsOutletModel implements Serializable {
    ...
    public static class Data implements Serializable{
        ...
        public void setOutletKyc(String outletKyc) {
            this.outletKyc = outletKyc;
        }

        public Object getAadhaarimg() {
            return aadhaarimg;
        }

        public void setAadhaarimg(Object aadhaarimg) {
